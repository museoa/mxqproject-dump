...
base=''
ADDON=xbmcaddon.Addon(id='plugin.video.mxqprojectwizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.2"
PATH = "The MXQ Project Wizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://www.mxqproject.com/files/gamingbuild/wizard/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("The MXQ Project Wizard","Downloading ",'', 'Please Wait')
